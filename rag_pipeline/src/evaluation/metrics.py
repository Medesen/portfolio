...
Plain module functions: every metric is a pure function of the retrieved and
relevant document ID lists, so there is no calculator object to construct.
"""
...
def calculate_all_metrics(
    ...
    if k_values is None:
        k_values = [5, 10, 20]
    metrics = {
        "mrr": reciprocal_rank(retrieved_doc_ids, relevant_doc_ids)
    }
